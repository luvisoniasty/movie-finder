...
export const getMovies = (page, minRating, maxRating, minYear, maxYear, language) => 
...
&primary_release_date.lte=${maxYear}&include_adult=false&include_video=false&page=${page}`);
